...
openssl req -out /root/TFTP/cert_test/ecdsa_ca_req.pem -newkey rsa:2048 -keyout /root/TFTP/cert_test/ecdsa_ca_key.pem -subj /C=US/ST=CA/L=CA/O=Fortinet/OU=FortiADC/CN=ecdsa_ca.pem -passout pass:fortinet -days 365

...
key_bits=2048
expire_days=3650
subj1=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="ecdsadomain1"
subj2=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="ecdsadomain2"
subj=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="rsadomain"
ca_name=ca-root
...
openssl req -new -key $sub1_cakey -sha256 -out $csr -subj $subj1
openssl ca -extensions v3_ca -batch -notext -in $csr -out $sub1_cacer
echo "===================Gen Sub1 CA OK===================="

#Sub2 CA
openssl genrsa -out $cakey $key_bits
openssl req -new -key $cakey -sha256 -out $csr -subj $subj2

...
key_bits=2048
expire_days=3650
subj1=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="ecdsa-intermediate1"
subj2=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="ecdsa-intermediate2"
subj=/C="US"/ST="CA"/L="RSA1"/O="Test"/OU="ecdsa"/CN="domain3.net"
ca_name=ca-root
